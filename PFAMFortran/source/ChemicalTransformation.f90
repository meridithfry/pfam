...
contains
   ...
   !***** Local Parameters *****************************  
    ...
    do day_count = 1,num_records
       ...
       call simuldiff2 (A(day_count),B(day_count),E(day_count),F(day_count),aqconc1(day_count),aqconc2(day_count),Time_int,new_aqconc1,new_aqconc2,aqconc_avg1(day_count,j), aqconc_avg2(day_count,j))
