...
contains   
    ...
    subroutine process_output
        ...
        drift_output,dates_of_application,Total_applications,bulk_density
        ...
        WashoutHalflife,WatercoHalflife,Hydrol1Halflife,PhotolyHalflife,VolatizHalflife,LeakageHalflife,BenthicHalflife,Hydrol2Halflife 
        ...
        open (UNIT = 34, FILE =outputfilename, STATUS = 'unknown',RECL =10000, IOSTAT = ierror) 
        ...
        write(34,*) "col 9:  Parent mass intentionally released or lost to weir leak(kg)"                ![release_mass(:,1)]
        ...
        write(34,*) "col 15, 21: Degradate #1 and #2 respectively, mass released or lost through wier(kg)"                           ![release_mass(:,2)]    
        ...
        write (34,*) benthic_depth, bulk_density, "= Benthic depth (m) & bulk density (g/ml)"
        ...
        write (34,*) Total_applications, "=number of drift events, followed by simulation date and drift out kg/ha"  
     
  
        write (34,'(3000(I10,1x))') dates_of_application
        write (34,'(3000(E10.3,1x))') drift_output
        write (34,*)
        write (34,*) "*************************************************************"
