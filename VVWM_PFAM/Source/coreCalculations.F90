...
subroutine MainLoop(index)
    ...
    real(8):: m1,m2,mavg1	!daily peak/average mass
    real(8):: mn1, mn2		!mass at end of time step
    real(8):: aqconc1, aqconc2  !aqueous concentrations for regions 1 and 2
    real(8):: new_aqconc1, new_aqconc2  !aqueous concentrations for regions 1 and 2
	...
	do day_count = 1,num_records
	   ...
	   call simuldiff2 (A(day_count),B(day_count),E(day_count),F(day_count),aqconc1,aqconc2,DELT,new_aqconc1,new_aqconc2,aqconc_avg1(day_count,index),aqconc_avg2(day_count,index))
        ...
        mavg1_store(day_count)= aqconc_avg1(day_count,index)/fw1(day_count)*daily_depth(day_count)*Area
...
subroutine simuldiff2 (A,B,E,F,m1,m2,T_end,mn1,mn2,mavg1,mavg2)
	    ...
	    real(8),intent(out)::mavg1		!average concentration over T_end
	    real(8),intent(out)::mavg2		!average concentration over T_end
